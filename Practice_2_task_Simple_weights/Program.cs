...
class Program
{
    ...
    {//функция, определяющая, является ли данное число простым
        ...
        {
            if (number % i == 0) return false;//если встречаем число, на которое number делится, то возвращаем false
        }
    ...
    static void Main(string[] args)
    {
        ...
        int N = int.Parse(sr.ReadLine());//считываем N
